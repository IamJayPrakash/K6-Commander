    ...
    <Card className="bg-card/50 backdrop-blur-sm">
      ...
      <CardContent className="space-y-4">
        ...
        <p>
          ...
          is that your sensitive data and test results never leave your local environment unless you
          explicitly action it.
        </p>
        ...
        <ul className="list-disc list-inside pl-4 space-y-2">
          ...
          <li>
            ...
            but not to the public internet.
          </li>
          <li>
            <strong>No Cloud Dependencies:</strong> The core functionality does not rely on any
            external cloud databases or authentication services. All data is stored locally.
          </li>
        </ul>
        ...
        <p className="font-bold text-destructive">
          ...
          for ensuring you only test applications and services you own or have explicit permission
          to test. Unauthorized load testing can be considered a denial-of-service (DoS) attack and
          may have legal consequences.
        </p>

        <h2 className="font-bold text-xl pt-4">Reporting Vulnerabilities</h2>
        <p>
          If you believe you have found a security vulnerability in K6 Commander, please report it
          to us responsibly. We will make every effort to address it promptly.
        </p>
      </CardContent>
    </Card>
  );
