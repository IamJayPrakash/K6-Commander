...
import { ServerCrash, RotateCw, ClipboardCopy, Check, Code } from 'lucide-react';
import {
  Accordion,
  AccordionContent,
  AccordionItem,
      ...
      <Card className="max-w-2xl w-full bg-card/50 backdrop-blur-sm border border-destructive/50 shadow-2xl shadow-destructive/10">
        ...
        <CardContent className="text-center">
          <p className="text-muted-foreground mb-6">
            Our systems have detected an anomaly. The technical team has been notified. You can
            attempt to reload the page or review the error details below.
          </p>
