    ...
    <Card className="bg-card/50 backdrop-blur-sm">
      ...
      <CardContent className="space-y-4">
        ...
        <p>
          ...
          communication with external cloud databases or services by default.
        </p>
        ...
        <p>
          Since we do not collect your data, we do not anticipate changes to this policy. However,
          if the application's functionality changes in a way that impacts data handling, we will
