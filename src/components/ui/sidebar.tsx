...
const SIDEBAR_WIDTH_ICON = "3.5rem" // increased width
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-card p-0 text-card-foreground border-none"
            style={
              {
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), state === 'collapsed' ? '!size-10 !p-3' : '', className)}
        {...props}
      >
        {buttonContent}
      </Comp>
